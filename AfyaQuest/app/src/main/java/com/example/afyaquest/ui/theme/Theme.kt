package com.example.afyaquest.ui.theme
...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimaryContainer = Color(0xFF0A2E2C),
    secondary = AfyaSecondary,
    onSecondary = Color.White,
    secondaryContainer = AfyaSecondaryContainer,
    onSecondaryContainer = Color(0xFF4A3810),
    tertiary = AfyaTertiary,
    onTertiary = Color.White,
    tertiaryContainer = AfyaTertiaryContainer,
    onTertiaryContainer = Color(0xFF0A2E2C),
