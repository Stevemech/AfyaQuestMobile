const en = {
  translation: {
    ...
    // CHV Detail
    chvDetail: {
      appProgress: 'App progress (level, XP, lives)',
      statLevel: 'Level',
      ...
      mapNoKey: 'Set VITE_GOOGLE_MAPS_API_KEY to enable map',
      noHouseCoordinates: 'No houses have coordinates yet',
      assignedModules: 'Assigned Modules & Lessons',
      ...
      confirmDeleteItinerary: 'Delete itinerary for {{date}}? This cannot be undone.',
    ...
    itinerary: {
      ...
      addressPlaceholderManual: 'Enter address manually',
