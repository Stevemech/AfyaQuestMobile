...
export const mockClinics: Clinic[] = [
  { id: 'clinic-1', name: 'Kibera East Clinic', location: 'Kibera East' },
  { id: 'clinic-2', name: 'Mathare Health Center', location: 'Mathare' },
];

export const mockCHVs: CHV[] = [
  {
    id: 'chv-1', name: 'Amina', email: 'amina@afyaquest.org', phone: '+254700000001',
    clinic: 'Kibera East', assignedHouses: 12, completedVisits: 9, pendingVisits: 3,
    completionRate: 74, lastActive: '2 days ago', isActive: true,
    status: 'active', flags: [],
  },
  {
    id: 'chv-2', name: 'Joseph', email: 'joseph@afyaquest.org', phone: '+254700000002',
    clinic: 'Kibera East', assignedHouses: 10, completedVisits: 4, pendingVisits: 6,
  ...
  },
  {
    ...
    clinic: 'Kibera East', assignedHouses: 8, completedVisits: 6, pendingVisits: 2,
  ...
  },
  {
    ...
    clinic: 'Kibera East', assignedHouses: 14, completedVisits: 12, pendingVisits: 2,
  ...
  },
  {
    ...
    clinic: 'Kibera East', assignedHouses: 6, completedVisits: 0, pendingVisits: 6,
...
export const mockHouses: Record<string, House[]> = {
  'chv-1': [
    { id: 'H-1023', assignedCHV: 'chv-1', assignedCHVName: 'Amina', latitude: -1.3133, longitude: 36.7876, distance: 0.4, visitStatus: 'pending', priority: 'high' },
    { id: 'H-1034', assignedCHV: 'chv-1', assignedCHVName: 'Amina', latitude: -1.3150, longitude: 36.7900, distance: 1.2, visitStatus: 'completed', priority: 'medium' },
    { id: 'H-1098', assignedCHV: 'chv-1', assignedCHVName: 'Amina', latitude: -1.3170, longitude: 36.7920, distance: 2.1, visitStatus: 'pending', priority: 'medium', daysPending: 4 },
  ],
  'chv-2': [
    { id: 'H-1034', assignedCHV: 'chv-2', assignedCHVName: 'Joseph', latitude: -1.3140, longitude: 36.7890, distance: 0.8, visitStatus: 'pending', priority: 'medium' },
    { id: 'H-1045', assignedCHV: 'chv-2', assignedCHVName: 'Joseph', latitude: -1.3160, longitude: 36.7910, distance: 1.5, visitStatus: 'overdue', priority: 'high', daysPending: 7 },
  ],
  'chv-3': [
    { id: 'H-1068', assignedCHV: 'chv-3', assignedCHVName: 'Faith', latitude: -1.3180, longitude: 36.7940, distance: 1.8, visitStatus: 'pending', priority: 'high', daysPending: 9 },
  ],
};
...
export const mockModuleProgress: ModuleProgress[] = [
  {
    ...
    modules: [
      { moduleId: 'mod-1', completed: true, score: 90 },
      { moduleId: 'mod-2', completed: true, score: 60 },
    ],
    overallProgress: 60,
  ...
  },
  {
    ...
    modules: [
      { moduleId: 'mod-1', completed: true, score: 100 },
      { moduleId: 'mod-2', completed: true, score: 100 },
    ],
    overallProgress: 100,
  ...
  },
  {
    ...
    modules: [
      { moduleId: 'mod-1', completed: false, score: 0 },
      { moduleId: 'mod-2', completed: false, score: 0 },
    ],
    overallProgress: 0,
  },
];
