...
deploy_lambda "admin-getNotifications" "$LAMBDA_DIR/getNotifications"
deploy_lambda "admin-markNotificationsRead" "$LAMBDA_DIR/markNotificationsRead"
...
add_api_route "GET" "/admin/notifications" "admin-getNotifications"
add_api_route "POST" "/admin/notifications/read" "admin-markNotificationsRead"
...
echo "  POST /admin/notifications/read"
